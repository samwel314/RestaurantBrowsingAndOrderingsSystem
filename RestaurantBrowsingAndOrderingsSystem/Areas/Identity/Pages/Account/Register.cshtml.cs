    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (CheckPhone != null)
                {
                    ModelState.AddModelError("", $"This {Input.PhoneNumber} Is Token ");
                    return Page();  
                }
                ...
                if (result.Succeeded)
                {
                    // Add Claim (UserType) > Admin , Customer 
                    // we will Change it soon By Check if is User Login (Admin)  true admin Claim false user Claim
                     Claim UserType = new Claim("UserType", StaticData.CustomerClaim);
